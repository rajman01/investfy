                        ...
                        <div className="col-12">
                            <div className="row">
                                <div className="col-7">
                                    ...
                                    <div className="mt-3">
                                        <h1 className="x20000-9669 border-class-1 madetommy-medium-new-car-50px">#{targeted_amount}&nbsp;
                                        ...
                                        <span className="x4000-9683 border-class-1 madetommy-medium-mountain-meadow-26px">&nbsp;#{progress}</span>
                                    </div>
                                    <div className="row">
